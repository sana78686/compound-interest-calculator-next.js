...
export const translations = {
  en: {
    logoMark: 'Compound Interest Calculator',
    nav: {
      home: 'Home',
      isaCalculator: 'ISA calculator',
      about: 'About',
      contact: 'Contact',
      blog: 'Blog',
    },
    ...
    seoHeroH1: 'Compound Interest Calculator',
    subtitle: 'Model savings and investments in your browser: pick a mode, tune rate and timeline, and see balance, interest, and optional cash flows — privately, with no account required.',
    compress: 'Compress',
    ...
    footerBlog: 'Blog',
    footerOther: 'OTHER',
    footerCopyrightPrefix: '© Compound Interest Calculator 2026 – ',
    ...
    contact: {
      ...
      intro: 'Contact us about the calculator, partnerships, or content on this site.',
    ...
    blog: {
      ...
      emptyBody:
        'No articles yet. We will publish guides on saving, ISAs, and compound growth here. You can still use the calculator on the home page anytime.',
      backHome: 'Back to home',
...
/** English only — no URL prefix. */
export const defaultLang = 'en'

export const supportedLangs = ['en']

/** URL prefix for a language (always empty for default English). */
...
/** Strings always resolve from English if missing in the active locale. */
const TRANSLATION_FALLBACK = 'en'

/** User-chosen UI language (persists across visits; survives refresh). */
const LOCALE_STORAGE_KEY = 'compound_interest_user_locale'

/** Legacy session hint from old geo detection — migrated once into localStorage. */
const LOCALE_HINT_KEY = 'compound_interest_locale_hint'
